...
public class VideoPlayerActivity extends AppCompatActivity {
    ...
    private ImageButton backIB, forwardIB, playIB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoSeekBar = findViewById(R.id.idSBProgress);
        ...
        playIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(videoView.isPlaying()){
                    videoView.pause();
                    playIB.setImageDrawable(getResources().getDrawable(R.drawable.ic_play));
                }else {
                    videoView.start();
                    playIB.setImageDrawable(getResources().getDrawable(R.drawable.ic_pause));
                }
            }
        });
    ...
    private void initializeSeekBar(){
        videoSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if(videoSeekBar.getId()==R.id.idSBProgress){
                    if(fromUser){
